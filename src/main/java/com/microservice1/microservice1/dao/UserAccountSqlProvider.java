...
import com.microservice1.microservice1.dto.UserAccountExample.Criteria;
import com.microservice1.microservice1.dto.UserAccountExample.Criterion;
...
public class UserAccountSqlProvider {
     ...
     *
     * @mbg.generated Sat Jan 26 18:06:28 CST 2019
     */
    public String countByExample(UserAccountExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("public.user_account");
    ...
    public String deleteByExample(UserAccountExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("public.user_account");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(UserAccount record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("public.user_account");

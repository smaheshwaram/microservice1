...
import com.microservice1.microservice1.dto.UsersExample.Criteria;
import com.microservice1.microservice1.dto.UsersExample.Criterion;
...
public class UsersSqlProvider {
    ...
    public String countByExample(UsersExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("information_schema.users");
    ...
    public String deleteByExample(UsersExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("information_schema.users");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Users record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("information_schema.users");
    ...
    public String selectByExample(UsersExample example) {
        ...
        sql.SELECT("name");
        sql.SELECT("salary");
        sql.FROM("information_schema.users");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("information_schema.users");
        ...
        if (record.getSalary() != null) {
            sql.SET("salary = #{record.salary,jdbcType=INTEGER}");
        }
